...
const Cards = (props) => {
  ...
  return (
    <Card
      className={
        props.type === "Signals" || props.type === "District-signals"
          ? "border-end"
          : "card-design"
      }
    >
    ...
    onTransitionEnd={handleTransitionEnd}> */}
      <Card.Body
        className={props.type === "District-signals" ? "d-no-padding" : ""}
      >
    ...
    <Row className="gy-3"> */}
            {props.type === "Timer" && (
              <>
                <Col xs={12} lg={8} xl={8} className="align-self-center">
                  <div className="timer-data">
                    <div
                      className="text-center icon-style bg-light mt-0 mb-3 p-1 border border-light rounded-circle"
                      style={{ color: props.chart.backgroundColor }}
                    >
                      <FontAwesomeIcon icon={Icon} />
                    </div>
                    <h3 className="mt-0 text-dark "> {props.count} </h3>
                    <h4 className="mt-0 title-text text-truncate">
                      {" "}
                      {props.title}{" "}
                    </h4>
                ...
                <Col xs={12} lg={4} xl={4} className="align-self-center">
            ...
            {props.type === "Signals" && (
              <>
                <Col
                  xs={12}
                  xl={5}
                  className="text-start rounded-circle bg-soft d-flex justify-content-center align-items-center"
                >
                  <FontAwesomeIcon
                    icon={Icon}
                    size="2xl"
